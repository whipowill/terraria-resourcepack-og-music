# Terraria: Original Music Resource Pack
...
- Download these files into ``Terraria/ResourcePacks/OGMusic/``
- Find MP3 files for the following tracks:
    - ``Overworld Day.mp3``
    - ``Overworld Night.mp3``
    - ``Rain.mp3``
- Copy and paste these MP3 files into ``Terraria/ResourcePacks/OGMusic/Content/Music/``
- Rename them as follows:
    - ``Overworld Day.mp3`` -> ``Music_46.mp3``
    - ``Overworld Night.mp3`` -> ``Music_47.mp3``
    - ``Rain.mp3`` -> ``Music_44.mp3``
- Launch the game and activate the pack

## Notes

There are the track names used to replace music in the game:
...
Music song IDs were taken from [this](https://forums.terraria.org/index.php?threads%2Fthe-ultimate-guide-to-content-creation-and-use-for-the-terraria-workshop.100652%2F#musicpack) forum post.